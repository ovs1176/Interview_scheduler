...
let interviewController = require("../controller/interview")
let validationMiddleware = require("../validation/interview")


// ROUTE 1: Get All the Interviews using: GET "/api/interviews/getuser"
router.get('/fetchallinterviews', interviewController.findAll);
router.post('/addinterview', interviewController.addinterview);
// router.post('/addinterview', validationMiddleware.addinterview , interviewController.addinterview);
// router.get('/updateinterview/:id', interviewController.updateinterview);
// router.get('/deleteinterview/:id', interviewController.deleteinterview);
